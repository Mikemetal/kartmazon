...
urlpatterns = patterns('',
    ...
    url(r'^', include('ciudad.urls')),
    url(r'^', include('estado.urls')),
    url(r'^', include('follows.urls')),
    url(r'^', include('fotosvehiculos.urls')),
    url(r'^', include('marca.urls')),
    url(r'^', include('modelo.urls')),
    url(r'^', include('ofertas.urls')),
    url(r'^', include('paquetes.urls')),
    url(r'^', include('tipovehiculo.urls')),
    url(r'^', include('usuarios.urls')),
    url(r'^', include('usuariosperfil.urls')),
